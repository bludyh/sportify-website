				...
				<div class="col-md-8">
					...
					<div class="panel-group panel-classic" id="accordionA">
		                ...
		                <div class="panel-heading">
			                <h4 class="panel-title"> 
			                	<a data-toggle="collapse" data-parent="#accordionA, #accordionB" href="#collapseOne">
									When does Eventime Conference 2017 will occur?</a> 
			                </h4>
		                </div>
	              	...
	              	<div class="panel panel-default">
		                <div class="panel-heading">
			                <h4 class="panel-title">
			                	<a data-toggle="collapse" class="collapsed" data-parent="#accordionA, #accordionB" href="#collapseTwo">Where does Eventime take place?</a>
			            	</h4>
		                </div>
				...
				<div class="col-md-4">
					...
					<div class="sidebar sidebar-right">
		                  ...
		                  <li>
		                    ...
		                    <div class="post-info">
		                        <h4 class="entry-title">
		                        	<a href="#">Eventime Founded to Use Event Planning as an Experiential Teaching Tool for Inner City Youth</a>
		                        </h4>
		                    </div>
		                    <div class="clearfix"></div>
		                  </li><!-- 2nd post end-->
		                  ...
		                  <li>
		                    ...
		                    <div class="post-info">
		                        <h4 class="entry-title">
		                        	<a href="#">See Eventime Creative Strategy to Tap Into New York City Marathon Buzz Station</a>
		                        </h4>
		                    </div>
		                    <div class="clearfix"></div>
		                  </li><!-- 3rd post end-->
...
<!-- Mirrored from themefunction.com/html/eventime/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2017 17:36:37 GMT -->
</html>