...
<?php include("../lib/templates/navbar.inc.html"); ?>
	...
	<section id="banner">
		<div class="banner-item" style="background-image:url(images/main-banner/1.jpg)">
			<div class="container">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="intro-content">
						<h2 class="intro-title">About Sportify</h2>
						<p class="intro-desc lead">This year’s festival will feature performers and sports from across the Netherlands, evening Abundantly saw. They're Herb of said of waters second second so morning fruitful own stars green beast. Second brought whales shall lights spirit fruitful every creepeth likeness have divided gathering. Have female living fill fish, without moved i behold they're was greater form forth.</p>
					...
					<div class="featured-tab">
						  	...
						  	<li class="active">
						  		<a class="animated fadeIn" href="#tab_a" data-toggle="tab">
						  			<span class="tab-head">
										...
										<span class="tab-text-title">Great Performers</span>					
									</span>
						  		</a>
						  	</li>
						  	<li>
						...
						<div class="tab-content">
					      <div class="tab-pane active animated fadeInRight" id="tab_a">
				        		<img class="about-tab-img pull-left" src="images/icon-image/singer.png" style="width: 250px; height: 250px;" alt="" />
				        		<h3 class="tab-content-title">Respected performers from all over the Netherlands</h3>
				        		<p>Aenean et dolor pretium, feugiat leom nongial, aliquettiabser libero.</p>
					        	<ul class="list-arrow">
				        ...
				        <div class="tab-pane animated fadeInRight" id="tab_b">
				            <img class="about-tab-img pull-right" src="images/icon-image/sports.png" style="width: 250px; height: 250px;" alt="" />
				        		<h3 class="tab-content-title">Great opportunity to network</h3>
				        		<p>A great opportunity to network with your peers from the web industry.</p>
					        	<ul class="list-arrow">
									<li>Maecenas nibh dolor</li>
									<li>Aliquettiabser libero</li>
									<li>Consectetur ut vestibulum</li>
				            ...
				            <img class="about-tab-img pull-left" src="images/icon-image/tab-img3.png" alt="" />
				        		<h3 class="tab-content-title">Food and drinks are provided for all attendees.</h3>
				        		<p>Aenean et dolor pretium, feugiat leom nongial, aliquettiabser libero. Consectetur ut vestibulum vivamus.</p>
					        	<ul class="list-arrow">
									<li>Maecenas nibh dolor</li>
									<li>Aliquettiabser libero</li>
									<li>Consectetur ut vestibulum</li>
				...
				<div class="facts-wrapper">
					<div class="col-sm-3 ts-facts">
						<div class="ts-facts-content">
							<h2 class="ts-facts-num"><span class="counterUp">15,000</span></h2>
							<h3 class="ts-facts-title">Participents</h3>
						</div>
					...
					<div class="col-sm-3 ts-facts">
						<div class="ts-facts-content">
							<h2 class="ts-facts-num"><span class="counterUp">8</span></h2>
							<h3 class="ts-facts-title">Performers</h3>
						</div>
						<div class="ts-facts-icon">
							<i class="fa fa-microphone"></i>
						</div>
	...
	<section id="ts-schedule" class="ts-schedule">
		<div class="container">
			<div class="row text-center">
				...
				<p class="section-sub-title">Full-day Events with Awesome Sports</p>
			</div><!--/ Title row end -->
	...
	<section id="ts-speakers" class="ts-speakers">
		<div class="container">
			<div class="row text-center">
				...
				<h2 class="section-title title-white">Awesome Performers</h2>
				<p class="section-sub-title">Party by night...</p>
			</div><!--/ Title row end -->
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="ts-speaker transparent">
						...
						<div class="ts-speaker-info">
							<h3 class="ts-speaker-name"><a href="#">Henry Sr. Flint</a></h3>
							<p class="ts-speaker-designation">Roermond, Rock and Roll</p>
						</div><!-- Info end -->
					</div><!-- Speaker end -->
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="ts-speaker transparent">
						...
						<div class="ts-speaker-info">
							<h3 class="ts-speaker-name"><a href="#">Melisa Lund</a></h3>
							<p class="ts-speaker-designation">Breda, Classical</p>
						</div><!-- Info end -->
					</div><!-- Speaker end -->
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="ts-speaker transparent">
						...
						<div class="ts-speaker-info">
							<h3 class="ts-speaker-name"><a href="#">Agaton Johnsson</a></h3>
							<p class="ts-speaker-designation">Rotterdam, Jazz Singer</p>
						</div><!-- Info end -->
					</div><!-- Speaker end -->
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="ts-speaker transparent">
						...
						<div class="ts-speaker-info">
							<h3 class="ts-speaker-name"><a href="#">Hendrick Henriksson</a></h3>
							<p class="ts-speaker-designation">Amsterdam, Classical Musician</p>
						</div><!-- Info end -->
					</div><!-- Speaker end -->
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="ts-speaker transparent">
						...
						<div class="ts-speaker-info">
							<h3 class="ts-speaker-name"><a href="#">Olle Gustavsson</a></h3>
							<p class="ts-speaker-designation">Tilburg, Rock and Roll</p>
						</div><!-- Info end -->
					</div><!-- Speaker end -->
				</div><!-- Speaker Col 1 end -->
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="ts-speaker transparent">
						...
						<div class="ts-speaker-info">
							<h3 class="ts-speaker-name"><a href="#">Romeo Gunnarsson</a></h3>
							<p class="ts-speaker-designation">Maastricht, Classical Rock</p>
						</div><!-- Info end -->
					</div><!-- Speaker end -->
				</div><!-- Speaker Col 2 end -->
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="ts-speaker transparent">
						...
						<div class="ts-speaker-info">
							<h3 class="ts-speaker-name"><a href="#">Greta Nyberg</a></h3>
							<p class="ts-speaker-designation">Founder of Chipper</p>
						</div><!-- Info end -->
					</div><!-- Speaker end -->
				</div><!-- Speaker Col 3 end -->
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="ts-speaker transparent">
						...
						<div class="ts-speaker-info">
							<h3 class="ts-speaker-name"><a href="#">Mattias Berglund</a></h3>
							<p class="ts-speaker-designation">It Consultant</p>
						</div><!-- Info end -->
					</div><!-- Speaker end -->
				</div><!-- Speaker Col 4 end -->
	...
	<section id="ts-sponsors" class="ts-sponsors">
		<div class="container">
			<div class="row text-center">
				...
				<h2 class="section-title">The Sportify Sports</h2>
				<p class="section-sub-title">Play by day...</p>
			</div><!--/ Title row end -->

			<div class="row text-center">
				<h3 class="sponsor-title">In-door Sports</h3>
			...
			<div class="row text-center">
				<h3 class="sponsor-title">Outdoor Sports</h3>
			...
			<div class="row text-center">
				<h3 class="sponsor-title">Other Sports</h3>
				<div class="col-xs-12 col-sm-3 col-md-3">
					<a href="#" class="sponsor-logo">
	...
	<section id="ts-venue" class="ts-venue">
		<div class="container">
			<div class="row text-center">
				...
				<h2 class="section-title title-white">Venu Information</h2>
				<p class="section-sub-title">Beautiful location in the city of Eindhoven</p>
			</div><!--/ Title row end -->
			...
			<div class="row venu-info">
				<div class="col-md-4">
					<div class="venu-info-content box1">
						...
						<p class="venu-info-text">PLEASE NOTE: The conference takes place at the Philips Stadium in the heart of Eindhoven</p>
				...
				<div class="col-md-4">
					<div class="venu-info-content box2">
						...
						<p class="venu-info-text">To get to the venu place, you can take one of the city bus lines or railway service. All the services are comfortable to reach into the place.</p>
						<a href="#" class="venu-info-link">Read More <i class="fa fa-angle-right"></i></a>
					</div><!-- Venu content end -->
				</div><!-- Col 2 end -->
				...
				<div class="col-md-4">
					<div class="venu-info-content box3">
						...
						<p class="venu-info-text">Camping spots are available upon request when buying tickets.</p>
						<a href="#" class="venu-info-link">Read More <i class="fa fa-angle-right"></i></a>
					</div><!-- Venu content end -->
				</div><!-- Col 3 end -->
...
<!-- Mirrored from themefunction.com/html/eventime/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2017 17:34:51 GMT -->
</html>